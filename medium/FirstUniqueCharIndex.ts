...
type Counter<Str extends string, Char extends string, Count extends number = 0> = Str extends ''
  ? Count
...
type FirstIndex<Str extends string, S extends string = Str> = S extends ''
  ? -1
